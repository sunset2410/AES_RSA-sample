	...
	public void showMSG(String msg1, String msg2){
        ...
        public void ShowMessageChatRieng(String title,String from ,String message){
           ...
           if(stt==7){
                    ...
                    String aes_plaintext=GiaiMaText.GiaiMaText(listchatrieng.get(from).yourkey,message);
        ...
        public void ReceiveKey(String title,String from ,String key){
           ...
           if(stt==14){ 
                   //lay noi dung cua tin nhan;                  
                    ...
                    listchatrieng.get(from).receive=true;
                    listchatrieng.get(from).yourkey=key;
                    String txt_aes=GiaiMaText.GiaiMaText(key,c); //giai ma noi dung cua message truoc khi hien thi;
                    listchatrieng.get(from).message_area.append(from+": Your key is "+key+"\n");// hien thi key vua nhan duoc; 
                    //hien thi noi dung tin nhan chat rieng; 
                    listchatrieng.get(b).setVisible(true);
        ...
        public void ResetKey(String title,String from){
            int stt = Integer.parseInt(title);
            if(stt==16){
                listchatrieng.get(from).receive=false;
                listchatrieng.get(from).send=false;
            }
        }
            ...
            .addGroup(p2Layout.createSequentialGroup()
                ...
                .addGroup(p2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(p2Layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(jtf_nick, javax.swing.GroupLayout.PREFERRED_SIZE, 198, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(18, 18, 18)

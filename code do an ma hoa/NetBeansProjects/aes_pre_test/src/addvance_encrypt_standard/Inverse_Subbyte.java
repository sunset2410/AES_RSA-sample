...
int[][] keyExpansion = new int[4][44]; // mang chua khoa mo rong co kich thuoc 44 word;moi hoa la 4 word; 
    ...
    public static void main(String[] args) {
     ...
     public static int[][] inverse_subbyte(int[][] data){
...
{0x17, 0x2B, 0x04, 0x7E, 0xBA, 0x77,0xD6, 0x26, 0xE1, 0x69, 0x14, 0x63, 0x55, 0x21, 0x0C, 0x7D}
         ...
         for(i=0;i<4;i++)
             for(j=0;j<4;j++)
             {
               ...
               row=current/16;
               column=current%16;
               data[i][j]=inverse_s_box[row][column];
             }
...
for(i=0;i<data.length;i++){
    //System.out.println("Hexa: " + Integer.toHexString(number)); ham chuyen tu he 10 sang he co so 16;

...
import JClientAES_work_with_file.String_to_Hexa;



public class MaHoaAnh {
    
    public static BufferedImage bi;
    
    public static void main(String[] args) throws FileNotFoundException, IOException {
        String path1= "C:\\Users\\chieu\\Desktop\\people1.png"; //luu anh truoc ma hoa;
        String path2= "C:\\Users\\chieu\\Desktop\\people2.png";  //luu anh sau ma hoa;
        String path3= "C:\\Users\\chieu\\Desktop\\key.txt";
       
       mahoaanh(path1,path2,path3);
        
        
    }
    
    
    public static void mahoaanh(String input_path,String output_path,String key_path){
        ...
        for(j=0;j<=w-1;j++){
         ...
         System.out.println("pixel sau ma hoa:");
         System.out.println(data[0][0].red+" " + data[0][0].green+" "+data[0][0].blue);

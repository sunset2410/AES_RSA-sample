...
public RSA_DEMO_final() {
BigInteger p = BigInteger.probablePrime(KEY_SIZE, random); //chon so nguyen to p phai khac q;.
...
RSA_DEMO_final key = new RSA_DEMO_final();
...
BigInteger message = new BigInteger("53");

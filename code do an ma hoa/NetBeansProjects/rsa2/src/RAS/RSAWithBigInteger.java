...
public static final int KEY_SIZE = 4; //độ dài khóa tính theo bít.
...
publicKey_e = BigInteger.probablePrime(KEY_SIZE, random); //chon public_key < phi;
...
String s = "1";
System.out.println("noi dung truoc ma hoa:"+s+"\n");
...
System.out.println("noi dung sau giai ma:"+d);

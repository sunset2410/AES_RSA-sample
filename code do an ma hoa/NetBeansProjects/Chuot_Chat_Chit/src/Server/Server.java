...
public class Server extends JFrame implements ActionListener{
	...
	private void go(){
		try {
			listUser = new Hashtable<String, ClientConnect>(); //tao list chua cac user
			...
			while(true){
				Socket client = server_socket.accept(); // chap nhan ket noi serversocket;
				ClientConnect clientconnect = new ClientConnect(this,client); //tao 1 ket noi moi
			}
		} catch (IOException e) {
	...
	public static void main(String[] args) {
		Server server1= new Server();// khoi tao 1 the hien cua class Server;

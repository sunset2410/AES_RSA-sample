...
public class JServer extends javax.swing.JFrame {
    ...
    public Hashtable<String,String> ListModulusKey = new Hashtable();
    /**
	...
	public void sendAll(String from, String msg){
		...
		while(e. hasMoreElements()){
			...
			if(name.compareTo(from)!=0) listUser.get(name).sendMSG("4",msg,from); //gui duoi dinh dang hien thi tren cua so chat;
		}
	}
